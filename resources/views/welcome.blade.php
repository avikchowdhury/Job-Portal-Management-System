...
<html lang="en">
  <head>
    <title>Job Finder &mdash; Website</title>
    <meta charset="utf-8">
...
@include('partials.head')
  ...
  @include('partials.nav')
    ...
    <div class="site-blocks-cover overlay inner-page" style="background-image:url({{ URL::asset('assets/images/hero_1.jpg') }});" data-aos="fade"  data-stellar-background-ratio="0.5">
      <div class="container">
